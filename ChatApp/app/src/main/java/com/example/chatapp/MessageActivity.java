...
public class MessageActivity extends AppCompatActivity {
   ...
   //user john
    ...
    //id of chat room for john and kaju
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(MessageActivity.this).load(getIntent().getStringExtra("img_of_roommmate")).placeholder(R.drawable.account_img).error(R.drawable.account_img).into(imgToolbar);
